...
class KDirOperator(__PyQt4_QtGui.QWidget):
    ...
    def contextMenuAboutToShow(self, *args, **kwargs): # real signature unknown
        pass

    def createView(self, *args, **kwargs): # real signature unknown
        pass

    def currentIconSizeChanged(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def newFileMenuSupportedMimeTypes(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def onlyDoubleClickSelectsFiles(self, *args, **kwargs): # real signature unknown
        pass

    def pathChanged(self, *args, **kwargs): # real signature unknown
        pass

    def prepareCompletionObjects(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setEnableDirHighlighting(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setNewFileMenuSupportedMimeTypes(self, *args, **kwargs): # real signature unknown
        pass

    def setOnlyDoubleClickSelectsFiles(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def updateSelectionDependentActions(self, *args, **kwargs): # real signature unknown
        pass
