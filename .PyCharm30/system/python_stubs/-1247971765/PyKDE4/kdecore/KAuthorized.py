...
class KAuthorized(): # skipped bases: <class 'sip.wrapper'>
    # no doc
    def allowUrlAction(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def authorizeUrlAction(self, *args, **kwargs): # real signature unknown
        pass
