...
class KDEPluginVerificationData(): # skipped bases: <class 'sip.wrapper'>
    # no doc
    ...
    dataVersion = None # (!) real value is ''
    KDEVersion = None # (!) real value is ''
    KDEVersionString = None # (!) real value is ''
