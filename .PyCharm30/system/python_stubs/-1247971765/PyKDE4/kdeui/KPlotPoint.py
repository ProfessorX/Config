...
class KPlotPoint(): # skipped bases: <class 'sip.wrapper'>
    # no doc
    def barWidth(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setBarWidth(self, *args, **kwargs): # real signature unknown
        pass
