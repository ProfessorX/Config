...
class KColorCells(__PyQt4_QtGui.QTableWidget):
    # no doc
    def color(self, *args, **kwargs): # real signature unknown
        pass

    def colorDoubleClicked(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def positionToCell(self, *args, **kwargs): # real signature unknown
        pass

    def resizeEvent(self, *args, **kwargs): # real signature unknown
        pass

    def selectedIndex(self, *args, **kwargs): # real signature unknown
        pass

    def setAcceptDrags(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setShading(self, *args, **kwargs): # real signature unknown
        pass
