...
class KDateComboBox(KComboBox):
    ...
    def resetDateRange(self, *args, **kwargs): # real signature unknown
        pass

    def resetMaximumDate(self, *args, **kwargs): # real signature unknown
        pass

    def resetMinimumDate(self, *args, **kwargs): # real signature unknown
        pass
