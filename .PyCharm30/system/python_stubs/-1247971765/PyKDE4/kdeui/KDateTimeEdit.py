...
class KDateTimeEdit(__PyQt4_QtGui.QWidget):
    # no doc
    def assignCalendarSystem(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setCalendarSystemsList(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def timeSpecChanged(self, *args, **kwargs): # real signature unknown
        pass

    def timeSpecEntered(self, *args, **kwargs): # real signature unknown
        pass
