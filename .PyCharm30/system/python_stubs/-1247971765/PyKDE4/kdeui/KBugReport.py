...
class KBugReport(KDialog):
    ...
    def messageBody(self, *args, **kwargs): # real signature unknown
        pass

    def sendBugReport(self, *args, **kwargs): # real signature unknown
        pass

    def setMessageBody(self, *args, **kwargs): # real signature unknown
        pass
