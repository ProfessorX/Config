...
class KColorCombo(__PyQt4_QtGui.QComboBox):
    # no doc
    ...
    def colors(self, *args, **kwargs): # real signature unknown
        pass

    def highlighted(self, *args, **kwargs): # real signature unknown
        pass

    def isCustomColor(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setColors(self, *args, **kwargs): # real signature unknown
        pass

    def showEmptyList(self, *args, **kwargs): # real signature unknown
        pass
