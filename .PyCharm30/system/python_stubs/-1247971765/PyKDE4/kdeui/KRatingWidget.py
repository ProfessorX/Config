...
class KRatingWidget(__PyQt4_QtGui.QFrame):
    # no doc
    ...
    def rating(self, *args, **kwargs): # real signature unknown
        pass

    def ratingChanged(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setOnlyPaintFullSteps(self, *args, **kwargs): # real signature unknown
        pass

    def setPixmap(self, *args, **kwargs): # real signature unknown
        pass

    def setPixmapSize(self, *args, **kwargs): # real signature unknown
        pass

    def setRating(self, *args, **kwargs): # real signature unknown
        pass
