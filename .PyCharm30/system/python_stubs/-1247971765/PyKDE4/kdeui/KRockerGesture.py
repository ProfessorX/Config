...
class KRockerGesture(): # skipped bases: <class 'sip.wrapper'>
    # no doc
    ...
    def mouseButtonName(self, *args, **kwargs): # real signature unknown
        pass

    def rockerName(self, *args, **kwargs): # real signature unknown
        pass
