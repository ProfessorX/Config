...
class QSslSocket(QTcpSocket):
    ...
    def addCaCertificates(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QSslSocket.addCaCertificates(str, QSsl.EncodingFormat format=QSsl.Pem, QRegExp.PatternSyntax syntax=QRegExp.FixedString) -> bool
    ...
    def addDefaultCaCertificates(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QSslSocket.addDefaultCaCertificates(str, QSsl.EncodingFormat format=QSsl.Pem, QRegExp.PatternSyntax syntax=QRegExp.FixedString) -> bool
    ...
    def connectToHostEncrypted(self, p_str, p_int, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QSslSocket.connectToHostEncrypted(str, int, QIODevice.OpenMode mode=QIODevice.ReadWrite)
        QSslSocket.connectToHostEncrypted(str, int, str, QIODevice.OpenMode mode=QIODevice.ReadWrite)
        """
        pass

    def connectToHostImplementation(self, p_str, p_int, QIODevice_OpenMode): # real signature unknown; restored from __doc__
        """ QSslSocket.connectToHostImplementation(str, int, QIODevice.OpenMode) """
        pass
    ...
    def setSocketOption(self, QAbstractSocket_SocketOption, p_object): # real signature unknown; restored from __doc__
        """ QSslSocket.setSocketOption(QAbstractSocket.SocketOption, object) """
        pass
    ...
    def socketOption(self, QAbstractSocket_SocketOption): # real signature unknown; restored from __doc__
        """ QSslSocket.socketOption(QAbstractSocket.SocketOption) -> object """
        return object()
