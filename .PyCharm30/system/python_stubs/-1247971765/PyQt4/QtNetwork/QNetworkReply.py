...
class QNetworkReply(__PyQt4_QtCore.QIODevice):
    ...
    def attribute(self, QNetworkRequest_Attribute): # real signature unknown; restored from __doc__
        """ QNetworkReply.attribute(QNetworkRequest.Attribute) -> object """
        return object()
    ...
    def header(self, QNetworkRequest_KnownHeaders): # real signature unknown; restored from __doc__
        """ QNetworkReply.header(QNetworkRequest.KnownHeaders) -> object """
        return object()
    ...
    def setAttribute(self, QNetworkRequest_Attribute, p_object): # real signature unknown; restored from __doc__
        """ QNetworkReply.setAttribute(QNetworkRequest.Attribute, object) """
        pass

    def setError(self, QNetworkReply_NetworkError, p_str): # real signature unknown; restored from __doc__
        """ QNetworkReply.setError(QNetworkReply.NetworkError, str) """
        pass
    ...
    def setHeader(self, QNetworkRequest_KnownHeaders, p_object): # real signature unknown; restored from __doc__
        """ QNetworkReply.setHeader(QNetworkRequest.KnownHeaders, object) """
        pass
