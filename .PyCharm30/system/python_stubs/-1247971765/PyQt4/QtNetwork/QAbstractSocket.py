...
class QAbstractSocket(__PyQt4_QtCore.QIODevice):
    ...
    def connectToHost(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QAbstractSocket.connectToHost(str, int, QIODevice.OpenMode mode=QIODevice.ReadWrite)
        QAbstractSocket.connectToHost(QHostAddress, int, QIODevice.OpenMode mode=QIODevice.ReadWrite)
        """
        pass

    def connectToHostImplementation(self, p_str, p_int, QIODevice_OpenMode_mode=None): # real signature unknown; restored from __doc__
        """ QAbstractSocket.connectToHostImplementation(str, int, QIODevice.OpenMode mode=QIODevice.ReadWrite) """
        pass
    ...
    def setSocketOption(self, QAbstractSocket_SocketOption, p_object): # real signature unknown; restored from __doc__
        """ QAbstractSocket.setSocketOption(QAbstractSocket.SocketOption, object) """
        pass
    ...
    def socketOption(self, QAbstractSocket_SocketOption): # real signature unknown; restored from __doc__
        """ QAbstractSocket.socketOption(QAbstractSocket.SocketOption) -> object """
        return object()
