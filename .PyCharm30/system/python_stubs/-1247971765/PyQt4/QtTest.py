# encoding: utf-8
# module PyQt4.QtTest
# from /usr/lib/python3/dist-packages/PyQt4/QtTest.cpython-34m-x86_64-linux-gnu.so
# by generator 1.135
# no doc
# no imports
...
class QTest(): # skipped bases: <class 'sip.wrapper'>
    # no doc
    ...
    def keyClicks(self, QWidget, p_str, Qt_KeyboardModifiers_modifier=None, int_delay=-1): # real signature unknown; restored from __doc__
        """ QTest.keyClicks(QWidget, str, Qt.KeyboardModifiers modifier=Qt.NoModifier, int delay=-1) """
        pass
    ...
    Click = 2
    KeyAction = None # (!) real value is ''
    MouseAction = None # (!) real value is ''
    MouseClick = 2
    MouseDClick = 3
    MouseMove = 4
    MousePress = 0
