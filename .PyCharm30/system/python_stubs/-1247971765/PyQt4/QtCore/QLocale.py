...
class QLocale(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QLocale()
    QLocale(str)
    ...
    def languageToString(self, QLocale_Language): # real signature unknown; restored from __doc__
        """ QLocale.languageToString(QLocale.Language) -> str """
        return ""
    ...
    def monthName(self, p_int, QLocale_FormatType_format=None): # real signature unknown; restored from __doc__
        """ QLocale.monthName(int, QLocale.FormatType format=QLocale.LongFormat) -> str """
        return ""
    ...
    def positiveSign(self): # real signature unknown; restored from __doc__
        """ QLocale.positiveSign() -> str """
        return ""

    def quoteString(self, p_str, QLocale_QuotationStyle_style=None): # real signature unknown; restored from __doc__
        """ QLocale.quoteString(str, QLocale.QuotationStyle style=QLocale.StandardQuotation) -> str """
        return ""
    ...
    def scriptToString(self, QLocale_Script): # real signature unknown; restored from __doc__
        """ QLocale.scriptToString(QLocale.Script) -> str """
        return ""
    ...
    def standaloneDayName(self, p_int, QLocale_FormatType_format=None): # real signature unknown; restored from __doc__
        """ QLocale.standaloneDayName(int, QLocale.FormatType format=QLocale.LongFormat) -> str """
        return ""

    def standaloneMonthName(self, p_int, QLocale_FormatType_format=None): # real signature unknown; restored from __doc__
        """ QLocale.standaloneMonthName(int, QLocale.FormatType format=QLocale.LongFormat) -> str """
        return ""
    ...
    def timeFormat(self, QLocale_FormatType_format=None): # real signature unknown; restored from __doc__
        """ QLocale.timeFormat(QLocale.FormatType format=QLocale.LongFormat) -> str """
        return ""
    ...
    def toDate(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QLocale.toDate(str, QLocale.FormatType format=QLocale.LongFormat) -> QDate
    ...
    def toDateTime(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QLocale.toDateTime(str, QLocale.FormatType format=QLocale.LongFormat) -> QDateTime
        QLocale.toDateTime(str, str) -> QDateTime
        """
        return QDateTime

    def toDouble(self, p_str): # real signature unknown; restored from __doc__
        """ QLocale.toDouble(str) -> (float, bool) """
        pass

    def toFloat(self, p_str): # real signature unknown; restored from __doc__
        """ QLocale.toFloat(str) -> (float, bool) """
        pass

    def toInt(self, p_str, int_base=0): # real signature unknown; restored from __doc__
        """ QLocale.toInt(str, int base=0) -> (int, bool) """
        pass

    def toLongLong(self, p_str, int_base=0): # real signature unknown; restored from __doc__
        """ QLocale.toLongLong(str, int base=0) -> (int, bool) """
        pass

    def toLower(self, p_str): # real signature unknown; restored from __doc__
        """ QLocale.toLower(str) -> str """
        return ""

    def toShort(self, p_str, int_base=0): # real signature unknown; restored from __doc__
        """ QLocale.toShort(str, int base=0) -> (int, bool) """
        pass
    ...
    def toTime(self, p_str, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QLocale.toTime(str, QLocale.FormatType format=QLocale.LongFormat) -> QTime
        QLocale.toTime(str, str) -> QTime
        """
        return QTime

    def toUInt(self, p_str, int_base=0): # real signature unknown; restored from __doc__
        """ QLocale.toUInt(str, int base=0) -> (int, bool) """
        pass

    def toULongLong(self, p_str, int_base=0): # real signature unknown; restored from __doc__
        """ QLocale.toULongLong(str, int base=0) -> (int, bool) """
        pass

    def toUpper(self, p_str): # real signature unknown; restored from __doc__
        """ QLocale.toUpper(str) -> str """
        return ""

    def toUShort(self, p_str, int_base=0): # real signature unknown; restored from __doc__
        """ QLocale.toUShort(str, int base=0) -> (int, bool) """
        pass

    def uiLanguages(self): # real signature unknown; restored from __doc__
        """ QLocale.uiLanguages() -> list-of-str """
        pass
    ...
    CurrencyIsoCode = 0
    CurrencySymbol = 1
    CurrencySymbolFormat = None # (!) real value is ''
    Cyprus = 56
    CyrillicScript = 2
    Czech = 28
    CzechRepublic = 57
    ...
    Mauritius = 137
    Mayotte = 138
    MeasurementSystem = None # (!) real value is ''
    Meru = 197
    MetricSystem = 0
    ...
    Nuer = 227
    NumberOption = None # (!) real value is ''
    NumberOptions = None # (!) real value is ''
    Nyankole = 185
    Nynorsk = 141
    Occitan = 86
    Oman = 162
    ...
    Qatar = 175
    Quechua = 93
    QuotationStyle = None # (!) real value is ''
