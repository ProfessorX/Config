...
class QTextBoundaryFinder(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QTextBoundaryFinder()
    ...
    def string(self): # real signature unknown; restored from __doc__
        """ QTextBoundaryFinder.string() -> str """
        return ""
    ...
    BoundaryReason = None # (!) real value is ''
    BoundaryReasons = None # (!) real value is ''
    BoundaryType = None # (!) real value is ''
    EndWord = 2
    Grapheme = 0
    Line = 2
    NotAtBoundary = 0
