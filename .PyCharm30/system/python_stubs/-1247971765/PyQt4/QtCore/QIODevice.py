...
class QIODevice(QObject):
    ...
    Append = 4
    NotOpen = 0
    OpenMode = None # (!) real value is ''
    OpenModeFlag = None # (!) real value is ''
    ReadOnly = 1
    ReadWrite = 3
    Text = 16
    Truncate = 8
