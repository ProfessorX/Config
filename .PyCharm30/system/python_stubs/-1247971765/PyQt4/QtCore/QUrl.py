...
class QUrl(): # skipped bases: <class 'sip.simplewrapper'>
    ...
    def allQueryItemValues(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.allQueryItemValues(str) -> list-of-str """
        pass
    ...
    def fromPunycode(self, QByteArray): # real signature unknown; restored from __doc__
        """ QUrl.fromPunycode(QByteArray) -> str """
        return ""

    def fromUserInput(self, p_str): # real signature unknown; restored from __doc__
    ...
    def queryItemValue(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.queryItemValue(str) -> str """
        return ""
    ...
    def setAuthority(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.setAuthority(str) """
        pass
    ...
    def setFragment(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.setFragment(str) """
        pass

    def setHost(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.setHost(str) """
        pass
    ...
    def setUrl(self, p_str, QUrl_ParsingMode=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QUrl.setUrl(str)
        QUrl.setUrl(str, QUrl.ParsingMode)
        """
        pass

    def setUserInfo(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.setUserInfo(str) """
        pass

    def setUserName(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.setUserName(str) """
        pass
    ...
    def topLevelDomain(self): # real signature unknown; restored from __doc__
        """ QUrl.topLevelDomain() -> str """
        return ""

    def toPunycode(self, p_str): # real signature unknown; restored from __doc__
        """ QUrl.toPunycode(str) -> QByteArray """
        return QByteArray

    def toString(self, QUrl_FormattingOptions_options=None): # real signature unknown; restored from __doc__
        """ QUrl.toString(QUrl.FormattingOptions options=QUrl.None) -> str """
        return ""
    ...
    FormattingOption = None # (!) real value is ''
    FormattingOptions = None # (!) real value is ''
    ParsingMode = None # (!) real value is ''
    RemoveAuthority = 30
    RemoveFragment = 128
    RemovePassword = 2
    RemovePath = 32
