...
class QState(QAbstractState):
    ...
    def assignProperty(self, QObject, p_str, p_object): # real signature unknown; restored from __doc__
        """ QState.assignProperty(QObject, str, object) """
        pass
