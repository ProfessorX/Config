...
class QMetaProperty(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QMetaProperty()
    ...
    def read(self, QObject): # real signature unknown; restored from __doc__
        """ QMetaProperty.read(QObject) -> object """
        return object()
    ...
    def write(self, QObject, p_object): # real signature unknown; restored from __doc__
        """ QMetaProperty.write(QObject, object) -> bool """
        return False
