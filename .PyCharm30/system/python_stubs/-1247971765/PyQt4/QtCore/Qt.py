...
class Qt(): # skipped bases: <class 'sip.wrapper'>
    # no doc
    def convertFromPlainText(self, p_str, Qt_WhiteSpaceMode_mode=None): # real signature unknown; restored from __doc__
        """ Qt.convertFromPlainText(str, Qt.WhiteSpaceMode mode=Qt.WhiteSpacePre) -> str """
        return ""
    ...
    def mightBeRichText(self, p_str): # real signature unknown; restored from __doc__
        """ Qt.mightBeRichText(str) -> bool """
        return False
    ...
    AnchorAttribute = None # (!) real value is ''
    AnchorBottom = 5
