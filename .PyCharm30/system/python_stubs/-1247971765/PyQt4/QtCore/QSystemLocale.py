...
class QSystemLocale(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QSystemLocale()
    ...
    def query(self, QSystemLocale_QueryType, p_object): # real signature unknown; restored from __doc__
        """ QSystemLocale.query(QSystemLocale.QueryType, object) -> object """
        return object()
