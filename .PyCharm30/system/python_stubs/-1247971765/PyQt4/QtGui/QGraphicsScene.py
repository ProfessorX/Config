...
class QGraphicsScene(__PyQt4_QtCore.QObject):
    ...
    def addSimpleText(self, p_str, QFont_font=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ QGraphicsScene.addSimpleText(str, QFont font=QFont()) -> QGraphicsSimpleTextItem """
        pass

    def addText(self, p_str, QFont_font=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ QGraphicsScene.addText(str, QFont font=QFont()) -> QGraphicsTextItem """
        pass
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QGraphicsScene.inputMethodQuery(Qt.InputMethodQuery) -> object """
        return object()
