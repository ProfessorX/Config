...
class QPrintEngine(): # skipped bases: <class 'sip.simplewrapper'>
    ...
    def property(self, QPrintEngine_PrintEnginePropertyKey): # real signature unknown; restored from __doc__
        """ QPrintEngine.property(QPrintEngine.PrintEnginePropertyKey) -> object """
        return object()

    def setProperty(self, QPrintEngine_PrintEnginePropertyKey, p_object): # real signature unknown; restored from __doc__
        """ QPrintEngine.setProperty(QPrintEngine.PrintEnginePropertyKey, object) """
        pass
