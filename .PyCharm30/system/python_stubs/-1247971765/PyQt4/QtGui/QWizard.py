...
class QWizard(QDialog):
    ...
    def buttonText(self, QWizard_WizardButton): # real signature unknown; restored from __doc__
        """ QWizard.buttonText(QWizard.WizardButton) -> str """
        return ""
    ...
    def setButtonText(self, QWizard_WizardButton, p_str): # real signature unknown; restored from __doc__
        """ QWizard.setButtonText(QWizard.WizardButton, str) """
        pass
    ...
    Stretch = 9
    WatermarkPixmap = 0
    WizardButton = None # (!) real value is ''
    WizardOption = None # (!) real value is ''
    WizardOptions = None # (!) real value is ''
    WizardPixmap = None # (!) real value is ''
    WizardStyle = None # (!) real value is ''
