...
class QTreeWidget(QTreeView):
    ...
    def findItems(self, p_str, Qt_MatchFlags, int_column=0): # real signature unknown; restored from __doc__
        """ QTreeWidget.findItems(str, Qt.MatchFlags, int column=0) -> list-of-QTreeWidgetItem """
        pass
    ...
    def mimeTypes(self): # real signature unknown; restored from __doc__
        """ QTreeWidget.mimeTypes() -> list-of-str """
        pass
    ...
    def setHeaderLabels(self, list_of_str): # real signature unknown; restored from __doc__
        """ QTreeWidget.setHeaderLabels(list-of-str) """
        pass
