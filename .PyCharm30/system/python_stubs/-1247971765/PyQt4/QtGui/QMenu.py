...
class QMenu(QWidget):
    ...
    def addAction(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        QMenu.addAction(str, QObject, SLOT(), QKeySequence shortcut=0) -> QAction
        QMenu.addAction(str, callable, QKeySequence shortcut=0) -> QAction
        QMenu.addAction(QIcon, str, QObject, SLOT(), QKeySequence shortcut=0) -> QAction
        QMenu.addAction(QIcon, str, callable, QKeySequence shortcut=0) -> QAction
        """
        return QAction
    ...
    def exec(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QMenu.exec() -> QAction
        QMenu.exec(QPoint, QAction action=None) -> QAction
        QMenu.exec(list-of-QAction, QPoint, QAction action=None) -> QAction
        QMenu.exec(list-of-QAction, QPoint, QAction, QWidget) -> QAction
        """
        return QAction
