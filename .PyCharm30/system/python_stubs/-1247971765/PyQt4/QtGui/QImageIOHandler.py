...
class QImageIOHandler(): # skipped bases: <class 'sip.simplewrapper'>
    """ QImageIOHandler() """
    ...
    def option(self, QImageIOHandler_ImageOption): # real signature unknown; restored from __doc__
        """ QImageIOHandler.option(QImageIOHandler.ImageOption) -> object """
        return object()
    ...
    def setOption(self, QImageIOHandler_ImageOption, p_object): # real signature unknown; restored from __doc__
        """ QImageIOHandler.setOption(QImageIOHandler.ImageOption, object) """
        pass
    ...
    Endianness = 11
    Gamma = 6
    ImageOption = None # (!) real value is ''
