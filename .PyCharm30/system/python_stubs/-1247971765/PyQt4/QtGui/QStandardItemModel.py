...
class QStandardItemModel(__PyQt4_QtCore.QAbstractItemModel):
    ...
    def data(self, QModelIndex, int_role=None): # real signature unknown; restored from __doc__
        """ QStandardItemModel.data(QModelIndex, int role=Qt.DisplayRole) -> object """
        return object()
    ...
    def findItems(self, p_str, Qt_MatchFlags_flags=None, int_column=0): # real signature unknown; restored from __doc__
        """ QStandardItemModel.findItems(str, Qt.MatchFlags flags=Qt.MatchExactly, int column=0) -> list-of-QStandardItem """
        pass
    ...
    def headerData(self, p_int, Qt_Orientation, int_role=None): # real signature unknown; restored from __doc__
        """ QStandardItemModel.headerData(int, Qt.Orientation, int role=Qt.DisplayRole) -> object """
        return object()
    ...
    def mimeTypes(self): # real signature unknown; restored from __doc__
        """ QStandardItemModel.mimeTypes() -> list-of-str """
        pass
    ...
    def setData(self, QModelIndex, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QStandardItemModel.setData(QModelIndex, object, int role=Qt.EditRole) -> bool """
        return False

    def setHeaderData(self, p_int, Qt_Orientation, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QStandardItemModel.setHeaderData(int, Qt.Orientation, object, int role=Qt.EditRole) -> bool """
        return False
    ...
    def setHorizontalHeaderLabels(self, list_of_str): # real signature unknown; restored from __doc__
        """ QStandardItemModel.setHorizontalHeaderLabels(list-of-str) """
        pass
    ...
    def setVerticalHeaderLabels(self, list_of_str): # real signature unknown; restored from __doc__
        """ QStandardItemModel.setVerticalHeaderLabels(list-of-str) """
        pass
