...
class QPaintEngine(): # skipped bases: <class 'sip.simplewrapper'>
    ...
    DirtyFlag = None # (!) real value is ''
    DirtyFlags = None # (!) real value is ''
    DirtyFont = 8
    DirtyHints = 512
    DirtyOpacity = 4096
    DirtyPen = 1
    ...
    OpenVG = 13
    PaintBuffer = 15
    PaintEngineFeature = None # (!) real value is ''
    PaintEngineFeatures = None # (!) real value is ''
    PainterPaths = 512
    ...
    Picture = 8
    PixmapTransform = 4
    PolygonDrawMode = None # (!) real value is ''
    PolylineMode = 3
    PorterDuff = 256
    PostScript = 6
