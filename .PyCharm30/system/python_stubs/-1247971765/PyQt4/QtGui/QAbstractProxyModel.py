...
class QAbstractProxyModel(__PyQt4_QtCore.QAbstractItemModel):
    ...
    def data(self, QModelIndex, int_role=None): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.data(QModelIndex, int role=Qt.DisplayRole) -> object """
        return object()
    ...
    def headerData(self, p_int, Qt_Orientation, p_int_1): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.headerData(int, Qt.Orientation, int) -> object """
        return object()

    def itemData(self, QModelIndex): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.itemData(QModelIndex) -> dict-of-int-object """
        pass
    ...
    def mimeTypes(self): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.mimeTypes() -> list-of-str """
        pass
    ...
    def setData(self, QModelIndex, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.setData(QModelIndex, object, int role=Qt.EditRole) -> bool """
        return False

    def setHeaderData(self, p_int, Qt_Orientation, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.setHeaderData(int, Qt.Orientation, object, int role=Qt.EditRole) -> bool """
        return False

    def setItemData(self, QModelIndex, dict_of_int_object): # real signature unknown; restored from __doc__
        """ QAbstractProxyModel.setItemData(QModelIndex, dict-of-int-object) -> bool """
        return False
