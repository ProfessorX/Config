...
class QImageReader(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QImageReader()
    ...
    def errorString(self): # real signature unknown; restored from __doc__
        """ QImageReader.errorString() -> str """
        return ""

    def fileName(self): # real signature unknown; restored from __doc__
        """ QImageReader.fileName() -> str """
        return ""
    ...
    def imageFormat(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QImageReader.imageFormat(str) -> QByteArray
    ...
    DeviceError = 2
    FileNotFoundError = 1
    ImageReaderError = None # (!) real value is ''
    InvalidDataError = 4
    UnknownError = 0
