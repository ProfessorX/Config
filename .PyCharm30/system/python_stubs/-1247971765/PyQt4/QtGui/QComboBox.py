...
class QComboBox(QWidget):
    ...
    def activated(self, *args, **kwargs): # real signature unknown
        ...
        QComboBox.activated[str] [signal]
        """
        pass

    def addItem(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QComboBox.addItem(str, object userData=None)
        QComboBox.addItem(QIcon, str, object userData=None)
        """
        pass

    def addItems(self, list_of_str): # real signature unknown; restored from __doc__
        """ QComboBox.addItems(list-of-str) """
        pass
    ...
    def currentIndexChanged(self, *args, **kwargs): # real signature unknown
        ...
        QComboBox.currentIndexChanged[str] [signal]
        """
        pass

    def currentText(self): # real signature unknown; restored from __doc__
        """ QComboBox.currentText() -> str """
        return ""
    ...
    def editTextChanged(self, *args, **kwargs): # real signature unknown
        """ QComboBox.editTextChanged[str] [signal] """
        pass
    ...
    def findData(self, p_object, int_role=None, Qt_MatchFlags_flags=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ QComboBox.findData(object, int role=Qt.UserRole, Qt.MatchFlags flags=Qt.MatchExactly|Qt.MatchCaseSensitive) -> int """
        pass

    def findText(self, p_str, Qt_MatchFlags_flags=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ QComboBox.findText(str, Qt.MatchFlags flags=Qt.MatchExactly|Qt.MatchCaseSensitive) -> int """
        pass
    ...
    def highlighted(self, *args, **kwargs): # real signature unknown
        ...
        QComboBox.highlighted[str] [signal]
        """
        pass
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QComboBox.inputMethodQuery(Qt.InputMethodQuery) -> object """
        return object()

    def insertItem(self, p_int, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QComboBox.insertItem(int, str, object userData=None)
        QComboBox.insertItem(int, QIcon, str, object userData=None)
        """
        pass

    def insertItems(self, p_int, list_of_str): # real signature unknown; restored from __doc__
        """ QComboBox.insertItems(int, list-of-str) """
        pass
    ...
    def itemData(self, p_int, int_role=None): # real signature unknown; restored from __doc__
        """ QComboBox.itemData(int, int role=Qt.UserRole) -> object """
        return object()
    ...
    def setItemData(self, p_int, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QComboBox.setItemData(int, object, int role=Qt.UserRole) """
        pass
    ...
    InsertPolicy = None # (!) real value is ''
    NoInsert = 0
    SizeAdjustPolicy = None # (!) real value is ''
