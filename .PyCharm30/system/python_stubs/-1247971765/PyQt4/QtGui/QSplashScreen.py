...
class QSplashScreen(QWidget):
    ...
    def messageChanged(self, *args, **kwargs): # real signature unknown
        """ QSplashScreen.messageChanged[str] [signal] """
        pass
    ...
    def showMessage(self, p_str, int_alignment=None, QColor_color=None): # real signature unknown; restored from __doc__
        """ QSplashScreen.showMessage(str, int alignment=Qt.AlignLeft, QColor color=Qt.black) """
        pass
