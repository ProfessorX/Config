...
class QTabBar(QWidget):
    ...
    def setTabData(self, p_int, p_object): # real signature unknown; restored from __doc__
        """ QTabBar.setTabData(int, object) """
        pass
    ...
    ButtonPosition = None # (!) real value is ''
    LeftSide = 0
    RightSide = 1
    RoundedEast = 3
    RoundedNorth = 0
