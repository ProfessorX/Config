...
class QToolBar(QWidget):
    """
    QToolBar(str, QWidget parent=None)
    ...
    def addAction(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        QToolBar.addAction(str, QObject, SLOT()) -> QAction
        QToolBar.addAction(str, callable) -> QAction
        QToolBar.addAction(QIcon, str, QObject, SLOT()) -> QAction
        QToolBar.addAction(QIcon, str, callable) -> QAction
        """
        return QAction
