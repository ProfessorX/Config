...
class QAction(__PyQt4_QtCore.QObject):
    ...
    def setData(self, p_object): # real signature unknown; restored from __doc__
        """ QAction.setData(object) """
        pass
    ...
    AboutQtRole = 3
    AboutRole = 4
    ActionEvent = None # (!) real value is ''
    ApplicationSpecificRole = 2
    HighPriority = 256
    Hover = 1
    LowPriority = 0
    MenuRole = None # (!) real value is ''
    NegativeSoftKey = 2
    NormalPriority = 128
    NoRole = 0
    NoSoftKey = 0
    ...
    QuitRole = 6
    SelectSoftKey = 3
    SoftKeyRole = None # (!) real value is ''
    TextHeuristicRole = 1
    Trigger = 0
