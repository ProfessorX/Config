...
class QMdiSubWindow(QWidget):
    ...
    def setOption(self, QMdiSubWindow_SubWindowOption, bool_on=True): # real signature unknown; restored from __doc__
    ...
    RubberBandMove = 8
    RubberBandResize = 4
    SubWindowOption = None # (!) real value is ''
    SubWindowOptions = None # (!) real value is ''
