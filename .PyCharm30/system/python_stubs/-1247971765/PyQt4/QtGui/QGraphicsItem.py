...
class QGraphicsItem(): # skipped bases: <class 'sip.wrapper'>
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QGraphicsItem.inputMethodQuery(Qt.InputMethodQuery) -> object """
        return object()
    ...
    def itemChange(self, QGraphicsItem_GraphicsItemChange, p_object): # real signature unknown; restored from __doc__
        """ QGraphicsItem.itemChange(QGraphicsItem.GraphicsItemChange, object) -> object """
        return object()
    ...
    def setData(self, p_int, p_object): # real signature unknown; restored from __doc__
        """ QGraphicsItem.setData(int, object) """
        pass
    ...
    GraphicsItemChange = None # (!) real value is ''
    GraphicsItemFlag = None # (!) real value is ''
    GraphicsItemFlags = None # (!) real value is ''
    ...
    NonModal = 0
    PanelModal = 1
    PanelModality = None # (!) real value is ''
    SceneModal = 2
    UserType = 65536
