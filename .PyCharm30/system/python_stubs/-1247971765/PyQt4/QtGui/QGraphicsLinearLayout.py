...
class QGraphicsLinearLayout(QGraphicsLayout):
    ...
    def addStretch(self, int_stretch=1): # real signature unknown; restored from __doc__
    ...
    def insertStretch(self, p_int, int_stretch=1): # real signature unknown; restored from __doc__
