...
class QSizePolicy(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QSizePolicy()
    ...
    def hasWidthForHeight(self): # real signature unknown; restored from __doc__
        """ QSizePolicy.hasWidthForHeight() -> bool """
        return False
    ...
    CheckBox = 4
    ComboBox = 8
    ControlType = None # (!) real value is ''
    ControlTypes = None # (!) real value is ''
    DefaultType = 1
    ExpandFlag = 2
    Expanding = 7
    Fixed = 0
