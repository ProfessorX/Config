...
class QGraphicsView(QAbstractScrollArea):
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QGraphicsView.inputMethodQuery(Qt.InputMethodQuery) -> object """
        return object()
    ...
    CacheModeFlag = None # (!) real value is ''
    CacheNone = 0
    DontAdjustForAntialiasing = 4
    DontClipPainter = 1
    DontSavePainterState = 2
    DragMode = None # (!) real value is ''
    FullViewportUpdate = 0
    MinimalViewportUpdate = 1
    NoAnchor = 0
    NoDrag = 0
    NoViewportUpdate = 3
    OptimizationFlag = None # (!) real value is ''
    OptimizationFlags = None # (!) real value is ''
    RubberBandDrag = 2
    ScrollHandDrag = 1
    SmartViewportUpdate = 2
    ViewportAnchor = None # (!) real value is ''
    ViewportUpdateMode = None # (!) real value is ''
