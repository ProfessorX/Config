...
class QCompleter(__PyQt4_QtCore.QObject):
    ...
    def activated(self, *args, **kwargs): # real signature unknown
        """
        QCompleter.activated[str] [signal]
    ...
    def completionPrefix(self): # real signature unknown; restored from __doc__
        """ QCompleter.completionPrefix() -> str """
        return ""
    ...
    def currentCompletion(self): # real signature unknown; restored from __doc__
        """ QCompleter.currentCompletion() -> str """
        return ""
    ...
    def highlighted(self, *args, **kwargs): # real signature unknown
        """
        QCompleter.highlighted[str] [signal]
    ...
    def pathFromIndex(self, QModelIndex): # real signature unknown; restored from __doc__
        """ QCompleter.pathFromIndex(QModelIndex) -> str """
        return ""
    ...
    def splitPath(self, p_str): # real signature unknown; restored from __doc__
        """ QCompleter.splitPath(str) -> list-of-str """
        pass
    ...
    CompletionMode = None # (!) real value is ''
    InlineCompletion = 2
    ModelSorting = None # (!) real value is ''
    PopupCompletion = 0
