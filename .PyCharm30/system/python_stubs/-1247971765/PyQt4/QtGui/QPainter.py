...
class QPainter(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QPainter()
    ...
    def boundingRect(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QPainter.boundingRect(QRectF, int, str) -> QRectF
    ...
    Antialiasing = 1
    CompositionMode = None # (!) real value is ''
    ...
    OpaqueHint = 1
    PixmapFragment = None # (!) real value is ''
    PixmapFragmentHint = None # (!) real value is ''
    PixmapFragmentHints = None # (!) real value is ''
    ...
    RenderHint = None # (!) real value is ''
    RenderHints = None # (!) real value is ''
