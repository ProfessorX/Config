...
class QTextBrowser(QTextEdit):
    ...
    def highlighted(self, *args, **kwargs): # real signature unknown
        ...
        QTextBrowser.highlighted[str] [signal]
        """
        pass
    ...
    def historyTitle(self, p_int): # real signature unknown; restored from __doc__
        """ QTextBrowser.historyTitle(int) -> str """
        return ""
    ...
    def loadResource(self, p_int, QUrl): # real signature unknown; restored from __doc__
        """ QTextBrowser.loadResource(int, QUrl) -> object """
        return object()
    ...
    def searchPaths(self): # real signature unknown; restored from __doc__
        """ QTextBrowser.searchPaths() -> list-of-str """
        pass
    ...
    def setSearchPaths(self, list_of_str): # real signature unknown; restored from __doc__
        """ QTextBrowser.setSearchPaths(list-of-str) """
        pass
