...
class QFontDialog(QDialog):
    ...
    def getFont(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QFontDialog.getFont(QFont, QWidget, str, QFontDialog.FontDialogOptions) -> (QFont, bool)
        QFontDialog.getFont(QFont, QWidget, str) -> (QFont, bool)
    ...
    FontDialogOption = None # (!) real value is ''
    FontDialogOptions = None # (!) real value is ''
    NoButtons = 1
