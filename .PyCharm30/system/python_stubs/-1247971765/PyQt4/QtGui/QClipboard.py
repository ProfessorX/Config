...
class QClipboard(__PyQt4_QtCore.QObject):
    ...
    def setText(self, p_str, QClipboard_Mode_mode=None): # real signature unknown; restored from __doc__
        """ QClipboard.setText(str, QClipboard.Mode mode=QClipboard.Clipboard) """
        pass
    ...
    def text(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QClipboard.text(QClipboard.Mode mode=QClipboard.Clipboard) -> str
