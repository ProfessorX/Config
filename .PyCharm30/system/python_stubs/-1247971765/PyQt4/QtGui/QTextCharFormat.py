...
class QTextCharFormat(QTextFormat):
    ...
    def fontFamily(self): # real signature unknown; restored from __doc__
        """ QTextCharFormat.fontFamily() -> str """
        return ""
    ...
    def fontHintingPreference(self): # real signature unknown; restored from __doc__
        """ QTextCharFormat.fontHintingPreference() -> QFont.HintingPreference """
        pass
    ...
    def setAnchorName(self, p_str): # real signature unknown; restored from __doc__
        """ QTextCharFormat.setAnchorName(str) """
        pass

    def setAnchorNames(self, list_of_str): # real signature unknown; restored from __doc__
        """ QTextCharFormat.setAnchorNames(list-of-str) """
        pass
    ...
    def setFontStyleHint(self, QFont_StyleHint, QFont_StyleStrategy_strategy=None): # real signature unknown; restored from __doc__
    ...
    def setTextOutline(self, QPen): # real signature unknown; restored from __doc__
    ...
    def setUnderlineColor(self, QColor): # real signature unknown; restored from __doc__
    ...
    UnderlineStyle = None # (!) real value is ''
    VerticalAlignment = None # (!) real value is ''
    WaveUnderline = 6
