...
class QSortFilterProxyModel(QAbstractProxyModel):
    ...
    def data(self, QModelIndex, int_role=None): # real signature unknown; restored from __doc__
        """ QSortFilterProxyModel.data(QModelIndex, int role=Qt.DisplayRole) -> object """
        return object()
    ...
    def headerData(self, p_int, Qt_Orientation, int_role=None): # real signature unknown; restored from __doc__
        """ QSortFilterProxyModel.headerData(int, Qt.Orientation, int role=Qt.EditRole) -> object """
        return object()
    ...
    def match(self, QModelIndex, p_int, p_object, int_hits=1, Qt_MatchFlags_flags=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ QSortFilterProxyModel.match(QModelIndex, int, object, int hits=1, Qt.MatchFlags flags=Qt.MatchStartsWith|Qt.MatchWrap) -> list-of-QModelIndex """
        pass
    ...
    def mimeTypes(self): # real signature unknown; restored from __doc__
        """ QSortFilterProxyModel.mimeTypes() -> list-of-str """
        pass
    ...
    def setData(self, QModelIndex, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QSortFilterProxyModel.setData(QModelIndex, object, int role=Qt.EditRole) -> bool """
        return False
    ...
    def setHeaderData(self, p_int, Qt_Orientation, p_object, int_role=None): # real signature unknown; restored from __doc__
        """ QSortFilterProxyModel.setHeaderData(int, Qt.Orientation, object, int role=Qt.EditRole) -> bool """
        return False
