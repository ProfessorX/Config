...
class QTextBlockFormat(QTextFormat):
    ...
    def setTabPositions(self, list_of_QTextOption_Tab): # real signature unknown; restored from __doc__
    ...
    LineHeightTypes = None # (!) real value is ''
    MinimumHeight = 3
