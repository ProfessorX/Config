...
class QGraphicsBlurEffect(QGraphicsEffect):
    ...
    def setBlurHints(self, QGraphicsBlurEffect_BlurHints): # real signature unknown; restored from __doc__
    ...
    AnimationHint = 2
    BlurHint = None # (!) real value is ''
    BlurHints = None # (!) real value is ''
    PerformanceHint = 0
    QualityHint = 1
