...
class QTextDocument(__PyQt4_QtCore.QObject):
    ...
    """
    def addResource(self, p_int, QUrl, p_object): # real signature unknown; restored from __doc__
        """ QTextDocument.addResource(int, QUrl, object) """
        pass
    ...
    def characterAt(self, p_int): # real signature unknown; restored from __doc__
        """ QTextDocument.characterAt(int) -> str """
        return ""
    ...
    def defaultStyleSheet(self): # real signature unknown; restored from __doc__
        """ QTextDocument.defaultStyleSheet() -> str """
        return ""
    ...
    def find(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QTextDocument.find(str, int position=0, QTextDocument.FindFlags options=0) -> QTextCursor
    ...
    def loadResource(self, p_int, QUrl): # real signature unknown; restored from __doc__
        """ QTextDocument.loadResource(int, QUrl) -> object """
        return object()
    ...
    def metaInformation(self, QTextDocument_MetaInformation): # real signature unknown; restored from __doc__
        """ QTextDocument.metaInformation(QTextDocument.MetaInformation) -> str """
        return ""
    ...
    def resource(self, p_int, QUrl): # real signature unknown; restored from __doc__
        """ QTextDocument.resource(int, QUrl) -> object """
        return object()
    ...
    def setMetaInformation(self, QTextDocument_MetaInformation, p_str): # real signature unknown; restored from __doc__
        """ QTextDocument.setMetaInformation(QTextDocument.MetaInformation, str) """
        pass
    ...
    def toHtml(self, QByteArray_encoding=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ QTextDocument.toHtml(QByteArray encoding=QByteArray()) -> str """
        pass

    def toPlainText(self): # real signature unknown; restored from __doc__
        """ QTextDocument.toPlainText() -> str """
        return ""
    ...
    HtmlResource = 1
    ImageResource = 2
    MetaInformation = None # (!) real value is ''
    RedoStack = 2
    ResourceType = None # (!) real value is ''
    Stacks = None # (!) real value is ''
