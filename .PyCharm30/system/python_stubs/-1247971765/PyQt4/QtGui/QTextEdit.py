...
class QTextEdit(QAbstractScrollArea):
    ...
    def find(self, p_str, QTextDocument_FindFlags_options=0): # real signature unknown; restored from __doc__
        """ QTextEdit.find(str, QTextDocument.FindFlags options=0) -> bool """
        return False
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QTextEdit.inputMethodQuery(Qt.InputMethodQuery) -> object """
        return object()
    ...
    def loadResource(self, p_int, QUrl): # real signature unknown; restored from __doc__
        """ QTextEdit.loadResource(int, QUrl) -> object """
        return object()
    ...
    AutoAll = -1
    AutoBulletList = 1
    AutoFormatting = None # (!) real value is ''
    AutoFormattingFlag = None # (!) real value is ''
    AutoNone = 0
    ExtraSelection = None # (!) real value is ''
    FixedColumnWidth = 3
    FixedPixelWidth = 2
    LineWrapMode = None # (!) real value is ''
    NoWrap = 0
    WidgetWidth = 1
