...
class QPixmap(QPaintDevice):
    ...
    def load(self, p_str, str_format=None, Qt_ImageConversionFlags_flags=None): # real signature unknown; restored from __doc__
        """ QPixmap.load(str, str format=None, Qt.ImageConversionFlags flags=Qt.AutoColor) -> bool """
        return False
    ...
    def save(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QPixmap.save(str, str format=None, int quality=-1) -> bool
