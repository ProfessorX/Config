...
class QTextFormat(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QTextFormat()
    QTextFormat(int)
    ...
    def property(self, p_int): # real signature unknown; restored from __doc__
        """ QTextFormat.property(int) -> object """
        return object()
    ...
    def setProperty(self, p_int, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        QTextFormat.setProperty(int, object)
    ...
    def stringProperty(self, p_int): # real signature unknown; restored from __doc__
        """ QTextFormat.stringProperty(int) -> str """
        return ""
    ...
    ObjectIndex = 0
    ObjectType = 12032
    ObjectTypes = None # (!) real value is ''
    OutlinePen = 2064
    PageBreakFlag = None # (!) real value is ''
    PageBreakFlags = None # (!) real value is ''
