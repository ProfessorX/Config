...
class QPrinter(QPaintDevice):
    ...
    def setPrinterSelectionOption(self, p_str): # real signature unknown; restored from __doc__
        """ QPrinter.setPrinterSelectionOption(str) """
        pass
