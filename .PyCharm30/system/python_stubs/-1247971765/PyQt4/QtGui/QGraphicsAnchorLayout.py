...
class QGraphicsAnchorLayout(QGraphicsLayout):
    ...
    def addAnchors(self, QGraphicsLayoutItem, QGraphicsLayoutItem_1, Qt_Orientations_orientations=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
