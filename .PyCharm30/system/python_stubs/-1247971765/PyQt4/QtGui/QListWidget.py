...
class QListWidget(QListView):
    ...
    def addItems(self, list_of_str): # real signature unknown; restored from __doc__
        """ QListWidget.addItems(list-of-str) """
        pass
    ...
    def currentTextChanged(self, *args, **kwargs): # real signature unknown
        """ QListWidget.currentTextChanged[str] [signal] """
        pass
    ...
    def findItems(self, p_str, Qt_MatchFlags): # real signature unknown; restored from __doc__
        """ QListWidget.findItems(str, Qt.MatchFlags) -> list-of-QListWidgetItem """
        pass
    ...
    def insertItems(self, p_int, list_of_str): # real signature unknown; restored from __doc__
        """ QListWidget.insertItems(int, list-of-str) """
        pass
    ...
    def mimeTypes(self): # real signature unknown; restored from __doc__
        """ QListWidget.mimeTypes() -> list-of-str """
        pass
