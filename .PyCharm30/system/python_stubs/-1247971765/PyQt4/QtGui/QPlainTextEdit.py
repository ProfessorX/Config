...
class QPlainTextEdit(QAbstractScrollArea):
    ...
    def anchorAt(self, QPoint): # real signature unknown; restored from __doc__
        """ QPlainTextEdit.anchorAt(QPoint) -> str """
        return ""
    ...
    def documentTitle(self): # real signature unknown; restored from __doc__
        """ QPlainTextEdit.documentTitle() -> str """
        return ""
    ...
    def find(self, p_str, QTextDocument_FindFlags_options=0): # real signature unknown; restored from __doc__
        """ QPlainTextEdit.find(str, QTextDocument.FindFlags options=0) -> bool """
        return False
    ...
    def inputMethodQuery(self, Qt_InputMethodQuery): # real signature unknown; restored from __doc__
        """ QPlainTextEdit.inputMethodQuery(Qt.InputMethodQuery) -> object """
        return object()
    ...
    def loadResource(self, p_int, QUrl): # real signature unknown; restored from __doc__
        """ QPlainTextEdit.loadResource(int, QUrl) -> object """
        return object()
    ...
    def toPlainText(self): # real signature unknown; restored from __doc__
        """ QPlainTextEdit.toPlainText() -> str """
        return ""
