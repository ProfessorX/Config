# encoding: utf-8
# module PyQt4.Qt
# from /usr/lib/python3/dist-packages/PyQt4/Qt.cpython-34m-x86_64-linux-gnu.so
# by generator 1.135
# no doc
...
from PyQt4.QtCore import (QAbstractAnimation, QAbstractEventDispatcher, 
    ...
    QBasicTimer, QBitArray, QBuffer, QByteArray, QByteArrayMatcher, 
    ...
    QGenericReturnArgument, QHistoryState, QIODevice, QLibrary, QLibraryInfo, 
    QLine, QLineF, QLocale, QMargins, QMetaClassInfo, QMetaEnum, QMetaMethod, 
    QMetaObject, QMetaProperty, QMetaType, QMimeData, QModelIndex, QMutex, 
    ...
    QProcess, QProcessEnvironment, QPropertyAnimation, QPyNullVariant, 
    QReadLocker, QReadWriteLock, QRect, QRectF, QRegExp, QResource, QRunnable, 
    QSemaphore, QSequentialAnimationGroup, QSettings, QSharedMemory, 
    QSignalMapper, QSignalTransition, QSize, QSizeF, QSocketNotifier, QState, 
    QStateMachine, QSysInfo, QSystemLocale, QSystemSemaphore, 
    QT_TRANSLATE_NOOP, QT_TR_NOOP, QT_TR_NOOP_UTF8, QTemporaryFile, 
    QTextBoundaryFinder, QTextCodec, QTextDecoder, QTextEncoder, QTextStream, 
    QTextStreamManipulator, QThread, QThreadPool, QTime, QTimeLine, QTimer, 
    QTimerEvent, QTranslator, QUrl, QUuid, QVariant, QVariantAnimation, 
    QWaitCondition, QWriteLocker, QXmlStreamAttribute, QXmlStreamAttributes, 
    QXmlStreamEntityDeclaration, QXmlStreamEntityResolver, 
    QXmlStreamNamespaceDeclaration, QXmlStreamNotationDeclaration, 
    QXmlStreamReader, QXmlStreamWriter, Q_ARG, Q_CLASSINFO, Q_ENUMS, Q_FLAGS, 
    Q_RETURN_ARG, Qt, QtCriticalMsg, QtDebugMsg, QtFatalMsg, QtMsgType, 
    QtSystemMsg, QtWarningMsg, SIGNAL, SLOT, bom, center, dec, endl, fixed, 
    flush, forcepoint, forcesign, left, lowercasebase, lowercasedigits, 
    noforcepoint, noforcesign, noshowbase, pyqtBoundSignal, 
    pyqtPickleProtocol, pyqtProperty, pyqtRemoveInputHook, 
...
PYQT_CONFIGURATION = {
    'sip_flags': '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_4_8_6',
}
