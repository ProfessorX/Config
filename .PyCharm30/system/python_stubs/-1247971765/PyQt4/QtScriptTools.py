...
# from /usr/lib/python3/dist-packages/PyQt4/QtScriptTools.cpython-34m-x86_64-linux-gnu.so
# by generator 1.135
# no doc
...
class QScriptEngineDebugger(__PyQt4_QtCore.QObject):
    ...
    ConsoleWidget = 0
    ContinueAction = 1
    DebuggerAction = None # (!) real value is ''
    DebuggerState = None # (!) real value is ''
    DebuggerWidget = None # (!) real value is ''
    DebugOutputWidget = 7
    ErrorLogWidget = 8
