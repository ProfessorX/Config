...
class KFontChooser(__PyQt4_QtGui.QWidget):
    # no doc
    ...
    AllFontDiffs = 7
    DisplayFlag = None # (!) real value is ''
    DisplayFlags = None # (!) real value is ''
    DisplayFrame = 2
    FamilyList = 1
    FixedFontsOnly = 1
    FixedWidthFonts = 1
    FontColumn = None # (!) real value is ''
    FontDiff = None # (!) real value is ''
    FontDiffFamily = 1
    FontDiffFlags = None # (!) real value is ''
    FontDiffSize = 4
    FontDiffStyle = 2
    FontListCriteria = None # (!) real value is ''
    NoDisplayFlags = 0
    NoFontDiffFlags = 0
    ScalableFonts = 2
    ShowDifferences = 4
