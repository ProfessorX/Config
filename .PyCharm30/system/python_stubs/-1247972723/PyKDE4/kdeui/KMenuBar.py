...
class KMenuBar(__PyQt4_QtGui.QMenuBar):
    # no doc
    ...
    def isTopLevelMenu(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setMargin(self, *args, **kwargs): # real signature unknown
        pass

    def setTopLevelMenu(self, *args, **kwargs): # real signature unknown
        pass

    def sizeHint(self, *args, **kwargs): # real signature unknown
        pass

    def slotReadConfig(self, *args, **kwargs): # real signature unknown
        pass
