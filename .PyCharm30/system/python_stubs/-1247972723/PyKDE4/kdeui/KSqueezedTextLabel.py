...
class KSqueezedTextLabel(__PyQt4_QtGui.QLabel):
    # no doc
    ...
    def setTextElideMode(self, *args, **kwargs): # real signature unknown
        pass

    def sizeHint(self, *args, **kwargs): # real signature unknown
        pass

    def squeezeTextToLabel(self, *args, **kwargs): # real signature unknown
        pass
