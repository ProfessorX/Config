...
class KSelectionProxyModel(__PyQt4_QtGui.QAbstractProxyModel):
    # no doc
    ...
    def filterBehavior(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def mapSelectionFromSource(self, *args, **kwargs): # real signature unknown
        pass

    def mapSelectionToSource(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setFilterBehavior(self, *args, **kwargs): # real signature unknown
        pass

    def setSourceModel(self, *args, **kwargs): # real signature unknown
        pass

    def sourceRootIndexes(self, *args, **kwargs): # real signature unknown
        pass
    ...
    ExactSelection = 3
    FilterBehavior = None # (!) real value is ''
    SubTreeRoots = 1
    SubTrees = 0
    SubTreesWithoutRoots = 2
