...
class KTitleWidget(__PyQt4_QtGui.QWidget):
    # no doc
    def autoHideTimeout(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setAutoHideTimeout(self, *args, **kwargs): # real signature unknown
        pass

    def setBuddy(self, *args, **kwargs): # real signature unknown
        pass
    ...
    ErrorMessage = 3
    ImageAlignment = None # (!) real value is ''
    ImageLeft = 0
    ImageRight = 1
    InfoMessage = 1
