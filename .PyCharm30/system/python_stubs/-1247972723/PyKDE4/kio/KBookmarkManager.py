...
class KBookmarkManager(__PyQt4_QtCore.QObject):
    # no doc
    def autoErrorHandlingEnabled(self, *args, **kwargs): # real signature unknown
        pass

    def bookmarkCompleteChange(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def managerForExternalFile(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setAutoErrorHandlingEnabled(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def slotEditBookmarksAtAddress(self, *args, **kwargs): # real signature unknown
        pass
