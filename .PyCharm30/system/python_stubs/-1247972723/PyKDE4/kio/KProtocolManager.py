...
class KProtocolManager(): # skipped bases: <type 'sip.wrapper'>
    ...
    def getSystemNameVersionAndMachine(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def persistentProxyConnection(self, *args, **kwargs): # real signature unknown
        pass

    def protocolForArchiveMimetype(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def userAgentForApplication(self, *args, **kwargs): # real signature unknown
        pass
    ...
    PACProxy = 2
    Prompt = 0
    ProxyAuthMode = None # (!) real value is ''
