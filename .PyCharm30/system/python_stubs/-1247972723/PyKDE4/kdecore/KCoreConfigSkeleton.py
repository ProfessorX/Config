...
class KCoreConfigSkeleton(__PyQt4_QtCore.QObject):
    # no doc
    ...
    def setSharedConfig(self, *args, **kwargs): # real signature unknown
        pass
    ...
    ItemBool = None # (!) real value is ''
    ItemDateTime = None # (!) real value is ''
    ItemDouble = None # (!) real value is ''
    ItemEnum = None # (!) real value is ''
    ItemInt = None # (!) real value is ''
    ItemIntList = None # (!) real value is ''
    ItemLongLong = None # (!) real value is ''
    ItemPassword = None # (!) real value is ''
    ItemPath = None # (!) real value is ''
    ItemPathList = None # (!) real value is ''
    ItemPoint = None # (!) real value is ''
    ItemProperty = None # (!) real value is ''
    ItemRect = None # (!) real value is ''
    ItemSize = None # (!) real value is ''
    ItemString = None # (!) real value is ''
    ItemStringList = None # (!) real value is ''
    ItemUInt = None # (!) real value is ''
    ItemULongLong = None # (!) real value is ''
    ItemUrl = None # (!) real value is ''
    ItemUrlList = None # (!) real value is ''
