...
# from /usr/lib/python2.7/dist-packages/PyKDE4/nepomuk.so
# by generator 1.135
# no doc
...
class Nepomuk(): # skipped bases: <type 'sip.wrapper'>
    ...
    ErrorCode = None # (!) real value is ''
    File = None # (!) real value is ''
    InvalidType = 2
    MassUpdateJob = None # (!) real value is ''
    NoError = 0
    Query = None # (!) real value is ''
    Resource = None # (!) real value is ''
    ResourceManager = None # (!) real value is ''
    Service = None # (!) real value is ''
    Tag = None # (!) real value is ''
    TagCloud = None # (!) real value is ''
    TagWidget = None # (!) real value is ''
    Thing = None # (!) real value is ''
    Types = None # (!) real value is ''
    UnknownError = 3
