...
link_target_prefix = "file:///usr/share/racket/doc/local-redirect/";

var user_link_dirs = [
 ["scribble-emacs", "file:///home/abrahamx/.racket/planet/300/6.1/cache/neil/scribble-emacs.plt/1/3/doc/scribble-emacs"]];
   ...
   for (var i = 0; i < elements.length; i++) {
     ...
     if (tag) {
       ...
       if (!user_loaded_link_targets[v]) {
         ...
         var p = "file:///home/abrahamx/.racket/6.1/doc/local-redirect_" + v + ".js";
         if (user_link_target_prefix) {
           p = user_link_target_prefix + p;
         }
         demand_load(p, false);
